...
page_title: "ixapi_product_offering_p2mp_vc Data Source - terraform-provider-ixapi"
subcategory: ""
description: |-
  Use this data source to reference a single p2mp virtual circuit product offering.
---

# ixapi_product_offering_p2mp_vc (Data Source)
...
- `id` (String) The *primary identifier* of the `P2MP Network Product Offering`.
