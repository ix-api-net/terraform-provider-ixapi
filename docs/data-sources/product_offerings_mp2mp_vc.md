...
page_title: "ixapi_product_offerings_mp2mp_vc Data Source - terraform-provider-ixapi"
subcategory: ""
description: |-
...
- `id` (String) The *primary identifier* of the `MP2MP Network Product Offering`.
