...
- `handover_metro_area_network_name` (String) Filter by name of the handover metro area network (e.g. FRA).
...
- `service_metro_area_network_name` (String) Filter by name of the service metro area network (e.g. FRA).
