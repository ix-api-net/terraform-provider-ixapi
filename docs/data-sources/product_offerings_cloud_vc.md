...
- `service_exchange_pops` (Block List) (see [below for nested schema](#nestedblock--product_offerings--service_exchange_pops))
...
<a id="nestedblock--product_offerings--service_exchange_pops"></a>
### Nested Schema for `product_offerings.service_exchange_pops`
