...
- `capacity_allocated` (Number) Sum of the bandwidth of all network service configs using the connection in Mbit/s.
...
- `id` (String) The *primary identifier* of the `Connection`.
...
- `metro_area` (String) Optional ID of the service metro area the connection is provided in.
- `metro_area_network` (String) Optional ID of the service metro area network the connection is present on.
