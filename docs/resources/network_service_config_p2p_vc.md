...
page_title: "ixapi_network_service_config_p2p_vc Resource - terraform-provider-ixapi"
subcategory: ""
description: |-
  Use the ixapi_network_service_config_p2p_vc resource to provision an access to a point to point virutal circuit.
---

# ixapi_network_service_config_p2p_vc (Resource)
