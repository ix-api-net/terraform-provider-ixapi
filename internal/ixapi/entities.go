...
type CloudNetworkProductOffering struct {
	...
	// this point in time.
	OrderableNotBefore *FlexibleTime `json:"orderable_not_before,omitempty"`

	// OrderableNotAfter This product offering will become unavailable for ordering after
	// this point in time.
	OrderableNotAfter *FlexibleTime `json:"orderable_not_after,omitempty"`
...
type IPAddress struct {
	...
	ValidNotBefore *FlexibleTime `json:"valid_not_before,omitempty"`

	// ValidNotAfter is a valid_not_after
	ValidNotAfter *FlexibleTime `json:"valid_not_after,omitempty"`
...
func (p ProblemResponse) Error() string {
	return fmt.Sprintf("%s (%d), %s",
		p.Title, p.Status, p.Detail.String())
}
